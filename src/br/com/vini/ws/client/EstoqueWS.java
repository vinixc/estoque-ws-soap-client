...
public interface EstoqueWS {
     ...
     * @param filtros
     * @return
     *     returns br.com.vini.ws.client.ListaItens
     */
    ...
    @RequestWrapper(localName = "TodosOsItens", targetNamespace = "http://ws.estoque.caelum.com.br/", className = "br.com.vini.ws.client.TodosOsItens")
    @ResponseWrapper(localName = "TodosOsItensResponse", targetNamespace = "http://ws.estoque.caelum.com.br/", className = "br.com.vini.ws.client.TodosOsItensResponse")
     ...
     * @param parameters
     * @return
     *     returns br.com.vini.ws.client.CadastrarItemResponse
